...
C,!1)}if(!a||a.constructor.toString().indexOf("HTMLVideoElement")<0)throw"Inputed element is not a video element.";var z=this,n="FastForwardMode",g=50,h=50,x=0.25,y=25,u=!1,t=Math.sqrt(195075)/100,k=0,A=0,r=0,s=0,I=a.controls,w=document.createElement("canvas"),D=document.createElement("canvas"),E=w.getContext("2d"),F=D.getContext("2d"),q=!1,p,v,H,G;J.prototype.events=H=new m;(function(){b=b||{};b.mode&&b.mode==="PlaybackMode"&&(n=b.mode);b.step_width&&b.step_height?(g=parseInt(b.step_width,10),h=
parseInt(b.step_height,10)):b.step&&(g=h=parseInt(b.step,10));b.minSceneDuration&&(x=parseFloat(b.minSceneDuration));b.threshold&&(y=parseFloat(b.threshold));b.debug&&(u=Boolean(b.debug));A=x;y*=t;p=g*h;if(u)v=document.createElement("div"),v.className="scd-debug",document.getElementsByTagName("body")[0].appendChild(v);a.readyState<3?a.addEventListener("durationchange",C,!1):C();J.prototype.start=n==="FastForwardMode"?function(){if(!q)a.controls=!1,a.currentTime=k,a.addEventListener("seeked",B,!1),
f()}:function(){if(!q)a.controls=!1,a.currentTime=0,a.addEventListener("timeupdate",d,!1),a.addEventListener("ended",l,!1),a.play()};G=p%2?function(a){a.sort(o);return a[(p+1)/2-1]}:function(a){a.sort(o);var b=(p+1)/2;return(a[b-1.5]+a[b-0.5])/2}})();J.prototype.pause=function(){if(!q){if(n==="FastForwardMode")a.controls=I,a.removeEventListener("seeked",B,!1);a.pause()}};J.prototype.stop=function(){z.pause();if(n==="FastForwardMode")a.controls=I;n==="FastForwardMode"?a.removeEventListener("seeked",
B,!1):(a.removeEventListener("timeupdate",d,!1),a.removeEventListener("ended",l,!1));q=!0}}J.prototype.sceneTimecodes=[];window.Scd=J;
