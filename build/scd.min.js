...
this.currentTime,d(),v=this.currentTime)}function e(){d();this.currentTime=l+=q}function w(){a.width=a.width?a.width:a.videoWidth;a.height=a.height?a.height:a.videoHeight;a.videoWidth/a.videoHeight>a.width/a.height?(s=a.width,t=a.videoHeight/a.videoWidth*a.width):(s=a.videoWidth/a.videoHeight*a.height,t=a.height);p.width=x.width=h;p.height=x.height=i;a.removeEventListener("durationchange",w,g)}if(!document.createElement("video").canPlayType)throw Error("Native video element not supported");if(!a||
0>a.constructor.toString().indexOf("HTMLVideoElement"))throw Error("Inputed element is not a video element.");var u=this,n="FastForwardMode",h=50,i=50,q=0.25,o=25,F=Math.sqrt(195075)/100,l=0,v=0,s=0,t=0,D=a.controls,p=document.createElement("canvas"),x=document.createElement("canvas"),z=p.getContext("2d"),A=x.getContext("2d"),m=g,r,C,B;E.prototype.events=C=new k;b=b||{};b.mode&&"PlaybackMode"===b.mode&&(n=b.mode);b.step_width&&b.step_height?(h=parseInt(b.step_width,10),i=parseInt(b.step_height,10)):
b.step&&(h=i=parseInt(b.step,10));b.minSceneDuration&&(q=parseFloat(b.minSceneDuration));b.threshold&&(o=parseFloat(b.threshold));v=q;o*=F;b=h*i;r=(b+1)/2-1;3>a.readyState?a.addEventListener("durationchange",w,g):w();E.prototype.start="FastForwardMode"===n?function(){if(!m){a.controls=g;a.currentTime=l;a.addEventListener("seeked",e,g);d()}}:function(){if(!m){a.controls=g;a.currentTime=0;a.addEventListener("timeupdate",y,g);a.addEventListener("ended",f,g);a.play()}};B=b%2?function(a){a.sort(j);return a[r]}:
function(a){a.sort(j);return(a[r-0.5]+a[r+0.5])/2};E.prototype.pause=function(){if(!m){if(n==="FastForwardMode"){a.controls=D;a.removeEventListener("seeked",e,g)}a.pause()}};E.prototype.stop=function(){u.pause();if(n==="FastForwardMode"){a.removeEventListener("seeked",e,g);a.controls=D}else{a.removeEventListener("timeupdate",y,g);a.removeEventListener("ended",f,g)}m=true}}E.prototype.sceneTimecodes=[];window.Scd=E;
