...
a.debug&&(u=Boolean(a.debug)),A=x;y*=r;o=g*h;if(u)v=document.createElement("div"),v.className="scd-debug",document.getElementsByTagName("body")[0].appendChild(v);b.addEventListener("durationchange",I,!1);K.prototype.start=q==="FastForwardMode"?function(){if(!p)b.currentTime=m,b.addEventListener("seeked",H,!1),j()}:function(){if(!p)b.currentTime=0,b.addEventListener("timeupdate",e,!1),b.addEventListener("ended",C,!1),b.play()};F=o%2?function(a){a.sort(i);return a[(o+1)/2-1]}:function(a){a.sort(i);
var b=(o+1)/2;return(a[b-1.5]+a[b-0.5])/2}})();K.prototype.pause=function(){if(!p){if(q==="FastForwardMode")b.controls=J,b.removeEventListener("seeked",H,!1);b.pause()}};K.prototype.stop=function(){z.pause();if(q==="FastForwardMode")b.controls=J;p=!0}}K.prototype.sceneTimecodes=[];window.Scd=K;
