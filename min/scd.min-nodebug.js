...
*/
function D(a,b,c){function h(a,b){return a-b}function d(){if(!l)if(m==="FastForwardMode"&&(a.ended||k>a.duration))i();else{y.drawImage(a,0,0,q,r,0,0,f,g);var b=[],c=y.getImageData(0,0,f,g).data,e=z.getImageData(0,0,f,g).data,d=c.length;do b.push(Math.sqrt(Math.pow(c[d-4]-e[d-4],2)+Math.pow(c[d+-3]-e[d+-3],2)+Math.pow(c[d+-2]-e[d+-2],2)));while(d-=4);A(b)>s&&(B.a("scenecut"),t.sceneTimecodes.push(k));z.drawImage(n,0,0,f,g,0,0,f,g)}}function i(){c&&c();t.stop()}function x(){if(this.currentTime-u>=o)k=
...
var t=this,m="FastForwardMode",f=50,g=50,o=0.25,s=25,E=Math.sqrt(195075)/100,k=0,u=0,q=0,r=0,C=a.controls,n=document.createElement("canvas"),w=document.createElement("canvas"),y=n.getContext("2d"),z=w.getContext("2d"),l=!1,p,B,A;D.prototype.events=B=new j;(function(){b=b||{};b.mode&&b.mode==="PlaybackMode"&&(m=b.mode);b.step_width&&b.step_height?(f=parseInt(b.step_width,10),g=parseInt(b.step_height,10)):b.step&&(f=g=parseInt(b.step,10));b.minSceneDuration&&(o=parseFloat(b.minSceneDuration));b.threshold&&
(s=parseFloat(b.threshold));u=o;s*=E;p=f*g;a.readyState<3?a.addEventListener("durationchange",v,!1):v();D.prototype.start=m==="FastForwardMode"?function(){if(!l)a.controls=!1,a.currentTime=k,a.addEventListener("seeked",e,!1),d()}:function(){if(!l)a.controls=!1,a.currentTime=0,a.addEventListener("timeupdate",x,!1),a.addEventListener("ended",i,!1),a.play()};A=p%2?function(a){a.sort(h);return a[(p+1)/2-1]}:function(a){a.sort(h);var b=(p+1)/2;return(a[b-1.5]+a[b-0.5])/2}})();D.prototype.pause=function(){if(!l){if(m===
"FastForwardMode")a.controls=C,a.removeEventListener("seeked",e,!1);a.pause()}};D.prototype.stop=function(){t.pause();m==="FastForwardMode"?(a.removeEventListener("seeked",e,!1),a.controls=C):(a.removeEventListener("timeupdate",x,!1),a.removeEventListener("ended",i,!1));l=!0}}D.prototype.sceneTimecodes=[];window.Scd=D;
